...
<body>
        ...
        <tbody>
            ...
            ?>                         
                        <tr>
                            ...
                            <td><button onclick="window.location.href='UserAction.php?MODE=U&USERID=<?php echo $row['USER_ID']; ?>';>Modify User</button></td>
                        </tr>
            <?php
                    }
                }
    ...
    <div class="button-container">
        <div class="left-buttons">
            ...
            <button <?php echo $NoRecordsFound ? 'disabled': ''; ?>>Modify User</button>
        </div>
